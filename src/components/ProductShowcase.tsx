...
import Y5 from '@/assets/Y5.webp?w=480;768;1100&format=avif;webp&quality=72&as=picture';
import SLV5 from '@/assets/SLV5.webp?w=480;768;1100&format=avif;webp&quality=72&as=picture';
import SB2 from '@/assets/SB2.webp?w=480;768;1100&format=avif;webp&quality=72&as=picture';
...
const ProductShowcase = () => {
  ...
  return (
    <section id="products" className="py-10 md:py-14 bg-background" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        <div ref={headingRef} className="text-center mb-8 md:mb-12 overflow-hidden">
          <ScrollTextReveal
            text="What We Export"
